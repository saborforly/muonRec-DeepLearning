...
import junonn_inference_res50_4 as junonn_inference_res
import junonn_loss
import junonn_inputs_tt_2 as junonn_inputs
...
def train():
    with tf.Graph().as_default():
        ...
        # inference model.
        logits,endpoint = junonn_inference_res.resnet_v2_152(float_images,6)
