...
def inference(images):
    ...
    conv_nb=conv_op(images_nb, [9,2,16], 9,name='conv_neighbor1_1') #conv 1D neighbor 9  strides=9
    images_nb=add_neighbor(conv_nb, nside)
    conv_nb=conv_op(images_nb, [9,16,16], 9,name='conv_neighbor1_2')
    pool1=mpool_op(conv_nb, [4], [4], name='pool1')
    nside1=int(nside/2) #32
    
    
    images_nb=add_neighbor(pool1, nside1)
    conv_nb=conv_op(images_nb, [9,16,64], 9,name='conv_neighbor2_1')
    images_nb=add_neighbor(conv_nb, nside1)
    conv_nb=conv_op(images_nb, [9,64,64], 9,name='conv_neighbor2_2') 
    pool2=mpool_op(conv_nb, [4], [4],name='pool2')
    nside2=int(nside1/2) #16

    images_nb=add_neighbor(pool2, nside2)
    conv_nb=conv_op(images_nb, [9,64,128], 9,name='conv_neighbor3_1')
    images_nb=add_neighbor(conv_nb, nside2)
    conv_nb=conv_op(images_nb, [9,128,128], 9,name='conv_neighbor3_2')
    images_nb=add_neighbor(conv_nb, nside2)
    conv_nb=conv_op(images_nb, [9,128,128], 9,name='conv_neighbor3_3')
    pool3=mpool_op(conv_nb, [4], [4],name='pool3')
    nside3=int(nside2/2)  #8
    
    images_nb=add_neighbor(pool3, nside3)
    conv_nb=conv_op(images_nb, [9,128,256], 9,name='conv_neighbor4_1')
    images_nb=add_neighbor(conv_nb, nside3)
    conv_nb=conv_op(images_nb, [9,256,256], 9,name='conv_neighbor4_2')
    images_nb=add_neighbor(conv_nb, nside3)
    conv_nb=conv_op(images_nb, [9,256,256], 9,name='conv_neighbor4_3')    
    pool4=mpool_op(conv_nb, [4], [4],name='pool4')
    nside4=int(nside3/2)  #4


    images_nb=add_neighbor(pool4, nside4)
    conv_nb=conv_op(images_nb, [9,256,512], 9,name='conv_neighbor5_1')    
    ...
    images_nb=add_neighbor(pool5, nside5)
    conv_nb=conv_op(images_nb, [9,512,512], 9,name='conv_neighbor6_1')
    images_nb=add_neighbor(conv_nb, nside5)
    conv_nb=conv_op(images_nb, [9,512,512], 9,name='conv_neighbor6_2')
    images_nb=add_neighbor(conv_nb, nside5)
    conv_nb=conv_op(images_nb, [9,512,512], 9,name='conv_neighbor6_3')
    pool6=mpool_op(conv_nb, [4], [4],name='pool6')
    nside6=int(nside5/2) #1

    #with tf.device('/gpu:1'): 
    resh1 = tf.reshape(pool6, [FLAGS.batch_size, -1])
